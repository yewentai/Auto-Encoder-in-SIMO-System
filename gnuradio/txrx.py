...
class txrx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "txrx")
        ...
        self.filter_fft_rrc_filter_0_0 = filter.fft_filter_ccc(1, firdes.root_raised_cosine(1, samp_rate, bandwidth, 0.35, 20), 1)
        self.filter_fft_rrc_filter_0 = filter.fft_filter_ccc(1, firdes.root_raised_cosine(1, samp_rate, bandwidth, 0.35, 20), 1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\Junchen Zhu\\Downloads\\Auto-Encoder-in-SIMO-System\\file\\tx.dat', True, 0, 0)
        ...
        self.connect((self.filter_fft_rrc_filter_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_rrc_filter_0_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, self.bandwidth, 0.35, 20))
