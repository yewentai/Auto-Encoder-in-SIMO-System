...
class qpsk_stage1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_stage1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_stage1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_stage1")
...
def main(top_block_cls=qpsk_stage1, options=None):
