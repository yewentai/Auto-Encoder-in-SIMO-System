...
class channel(gr.top_block):
    ...
    def __init__(self):
        ...
        self.file_sink_path = file_sink_path = "./file/rx2.dat"
        ...
        self.connect(
            (self.channels_fading_model_0, 0), (self.blocks_file_sink_0_0_0, 0)
        )

    def closeEvent(self, event):
        self.settings = Qt.QSettings("GNU Radio", "channel_simo")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.channels_fading_model_0.set_fDTs((0.01 / self.samp_rate))
