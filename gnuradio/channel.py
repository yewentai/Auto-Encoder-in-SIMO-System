...
class channel(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channels_fading_model_0 = channels.fading_model( 8, (4.0/samp_rate), True, 4.0, 0 )
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '../file/rx.dat', False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.channels_fading_model_0.set_fDTs((4.0/self.samp_rate))
