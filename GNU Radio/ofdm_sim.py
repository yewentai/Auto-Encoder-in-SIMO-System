...
class ofdm_sim(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM Simulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM Simulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_sim")
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.channels_fading_model_0, 0))
...
def main(top_block_cls=ofdm_sim, options=None):
