...
class qpsk_stage2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_stage2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_stage2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_stage2")
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.qtgui_number_sink_0, 0))
        ...
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.qtgui_number_sink_1, 0))
...
def main(top_block_cls=qpsk_stage2, options=None):
